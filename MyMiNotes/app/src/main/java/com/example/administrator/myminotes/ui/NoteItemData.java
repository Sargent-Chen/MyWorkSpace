...
public class NoteItemData {
    static final String [] PROJECTION = new String [] {
        ...
        private static final int ALERTED_DATE_COLUMN          = 4;
        private static final int SNIPPET_COLUMN               = 5;
        private static final int WIDGET_ID_COLUMN             = 6;
        private static final int WIDGET_TYPE_COLUMN           = 7;
        private static final int BG_COLOR_ID_COLUMN           = 8;
        private static final int HAS_ATTACHMENT_COLUMN        = 9;
        private static final int NOTES_COUNT_COLUMN           = 10;
